...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        <div class="container-fluid">
            ...
            <a class="navbar-brand me-auto ms-lg-0 ms-3 text-uppercase fw-bold" href="../Pages/Dashboard.php"> 🔑 Cipher Auth</a>
            <ul class="navbar-nav">
    ...
    <main class="mt-5 pt-3">
        ...
        href=" #!" role="button"><i class="bi bi-facebook"></i></a>
                    ...
                    <div class="text-center p-3" style="background-color: rgb(33, 37, 41);">
                        © 2022 Copyright:
                        <a class="text-white" href="#" style="text-decoration: none;">🔑 Cipher Auth</a>
                        <!-- </div> -->
                        <!-- Copyright -->
                </footer>
            </div>
